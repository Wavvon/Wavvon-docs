...
waits for an operator who needs a second box — see the Ideas discussion
[Farm across more than one
machine](https://github.com/Wavvon/Wavvon-docs/discussions/4). The proxy reaches
