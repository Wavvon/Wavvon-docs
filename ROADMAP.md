...
- Full audit with all 46 findings (file:line and effort): [`code-audit-2026-06-11.md`](code-audit-2026-06-11.md).
  Remaining open: H12 (missing indexes — partially done in hub migrations), H13 (federated_bans index — done in hub migrations), H22 (badge-offer auth), H23 (preview SSRF proxy-aware), W25 (41 orphaned web CSS classes).
