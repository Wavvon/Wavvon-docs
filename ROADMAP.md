...
- **2026-06-12 pilot feedback: desktop issues remaining (D8, D10)** — D1 fixed 2026-06-27 (whisper panel portal). D7 fixed 2026-06-27 (roles submenu in user context menu for admins). D8: banner spacers immutable. D10: no Activity view (wishlist). Details: [pilot-feedback-2026-06-12.md](pilot-feedback-2026-06-12.md).
