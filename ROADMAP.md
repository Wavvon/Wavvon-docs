...
- **Android client** — Tauri 2 shell + browser platform layer. Designed in [`docs/android-client.md`](docs/android-client.md). Debug APK builds. Remaining: release signing keystore, real app icons.
