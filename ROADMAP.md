...
- Full audit with all 46 findings (file:line and effort): [`code-audit-2026-06-11.md`](code-audit-2026-06-11.md).
  Remaining open: H12 (missing indexes — partially done in hub migrations), H13 (federated_bans index — done in hub migrations), H15 (farm-token path writes), H16 (federated DM inline delivery), H22 (badge-offer auth), H23 (preview SSRF proxy-aware), W25 (41 orphaned web CSS classes).
  Fixed: H9 (CORS warn — 2026-06-27), H11 (get_messages N+1 → 3 bulk queries — **FIXED 2026-06-27**), H14 (list_members N+M+1 → 3 queries, LIMIT 1000 — **FIXED 2026-06-27**), H17 (tantivy Mutex unwrap — **FIXED 2026-06-27**), H20 (chat broadcast capacity 256→4096, lagged WS frame — **FIXED 2026-06-27**), H21 (handle_typing ban check — 2026-06-27).
